...
(define (problem transport-city-sequential-40nodes-1000size-4degree-100mindistance-4trucks-16packages-2008seed)
 ...
 (:objects
  ...
  truck-1 - truck-normal
  truck-2 - truck-normal
  truck-3 - truck-frio
  truck-4 - truck-frio
  package-1 - package-normal
  package-2 - package-normal
  package-3 - package-normal
  package-4 - package-normal
  package-5 - package-normal
  package-6 - package-normal
  package-7 - package-normal
  package-8 - package-normal
  package-9 - package-normal
  package-10 - package-frio
  package-11 - package-frio
  package-12 - package-frio
  package-13 - package-frio
  package-14 - package-frio
  package-15 - package-frio
  package-16 - package-frio
